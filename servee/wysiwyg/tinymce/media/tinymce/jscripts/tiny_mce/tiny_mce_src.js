	...
	tinymce.create('tinymce.dom.Serializer', {
		Serializer : function(s) {
			...
			t.settings = s = extend({
				...
				closed : /^(br|hr|input|meta|img|link|param|area|inline)$/,
